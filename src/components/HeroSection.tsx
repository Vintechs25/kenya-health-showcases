    ...
    <section className="relative min-h-[600px] md:min-h-[700px] flex items-center">
      ...
      <div className="container relative z-10 py-20 md:py-32">
        <motion.div
          ...
          className="max-w-2xl"
        >
          <div className="inline-flex items-center gap-2 rounded-full bg-accent/20 px-4 py-1.5 mb-6 border border-accent/30">
          ...
          <p className="text-base md:text-lg text-primary-foreground/65 mb-8 max-w-lg">
            ...
            Providing compassionate, quality healthcare to our community with modern facilities and dedicated medical professionals.
          </p>
